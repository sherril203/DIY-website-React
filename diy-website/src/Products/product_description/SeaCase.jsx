...
// const SeaCase = () => {
//   const product = [
//     { product_img: sea, product_name: "sea blue Phone Case", price: 200 }
//   ];
...
const SeaCase = () => {
  const product = [
    {
      product_img: sea,
      product_name: "Sea Blue Phone Case",
      price: 200
    }
  ];
    ...
    <div className='bg-stone-100 min-h-screen'>
      ...
      <div className='p-10 mt-18'>
        {product.map((item, index) => (
          <div
            key={index}
            className="bg-white shadow p-6 rounded max-w-4xl  mx-auto flex flex-col md:flex-row gap-6"
          >
            {/* Left: Main Image + Side Images */}
