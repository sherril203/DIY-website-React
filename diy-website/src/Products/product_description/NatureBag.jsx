...
import { useParams, Link } from 'react-router-dom'; // ✅ Corrected
import UserNav from '../../Pages/Userpage/UserNav';
import Footer from '../../common/Footer';
import { toast, ToastContainer } from 'react-toastify';
import 'react-toastify/dist/ReactToastify.css';
...
const NatureBag = () => {
  ...
  const unitPrice = Number(product.product_price || product.Price || product.price || 0);
  ...
  return (
    <div className='bg-stone-100'>
      ...
      <div className='p-6'>
        <div className="bg-white shadow p-6 rounded max-w-4xl mt-10 mx-auto flex flex-col md:flex-row gap-6">
          {/* Left: Image */}
          <div className="flex-1 flex justify-center items-center">
            <img
